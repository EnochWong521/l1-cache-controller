...
REM
REM Generated by Vivado on Sun Jul 05 22:33:09 -0700 2026
...
echo "xvlog --incr --relax -L uvm -prj addr_decode_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj addr_decode_tb_vlog.prj -log xvlog.log
